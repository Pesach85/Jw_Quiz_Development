window.JW_STORIES = [
  ...
  // ── Episodio 4: Le Pecore e le Capre ─────────────────────────────────────────
  {
    id: 4,
  ...
  // ── Episodio 6: Elia e la Siccità ────────────────────────────────────────────
  {
    ...
    visibleKeys: ["270B-1F3FD", "2614", "1F525", "2601", "1F327"],
    hiddenKeys: ["1F932-1F3FC", "1F404"],
    hintKey: "1F6BE",
    imageCaptions: [
  ...
  // ── Episodio 7: Ester Salva il Popolo ────────────────────────────────────────
  {
    id: 7,
    ...
    visibleKeys: ["1F932-1F3FD", "1F6BC", "1F4E31", "1F442-1F3FE", "japanese_dolls_facebook"],
  ...
  // ── Episodio 10: La Profezia della Pace di Isaia ─────────────────────────────
  {
    id: 10,
    ...
    visibleKeys: ["1F932-1F3FC", "1F51A", "2935", "1F199"],
  ...
  // ── Episodio 14: Giuseppe Perdona i Fratelli ─────────────────────────────────
  {
    id: 14,
  ...
  // ── Episodio 16: La Nascita di Mosè ──────────────────────────────────────────
  {
    id: 16,
  ...
  // ── Episodio 18: Il Buon Samaritano ──────────────────────────────────────────
  {
    id: 18,
