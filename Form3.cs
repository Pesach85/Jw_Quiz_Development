...
namespace Jw_Quiz_Development
{
    public partial class Form3 : Form
    {
        ...
        private void storia3ToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void storia3ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Hide();
            new Forms_list().Storia3();
            this.Close();
        ...
        private void storia3ToolStripMenuItem2_Click(object sender, EventArgs e)
        {
            this.Hide();
